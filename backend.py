...
def chat_with_ai(user_input):
    formatted_input = f"You are an AI named 'chat helper.' Your mission is to help people with what they ask you They will provide input, and you should respond to them. Always answer what they ask you have controll on there pc you can open program and avoid saying mean things and keep it short.\nUser: {user_input}\nAI:"
